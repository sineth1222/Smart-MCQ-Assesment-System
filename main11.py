...
APP.title('MCQ Master APP')

#76448A
def menu():
    mainF = Frame(APP, bg='#fff')
    mainF.place(width=1750, height=950)
    ...
    Button(mainF, text='Available Courses',command=av_cours , fg='white', bg='#EF930C', border=0, activebackground='#F3F7D7',
           activeforeground='#F85511', font=('SimSun', 18, 'bold')).place(x=250, y=750, height=50, width=300)

    Button(mainF, text='Sign in',command=signin, fg='white', bg='blue', border=0, activebackground='#AED6F1',
           activeforeground='#76448A', font=('SimSun', 18, 'bold')).place(x=1250, y=700, height=50, width=300)
    Button(mainF, text='Register',command=register, fg='white', bg='blue', border=0, activebackground='#AED6F1',
           activeforeground='#76448A', font=('SimSun', 18, 'bold')).place(x=1250, y=800, height=50, width=300)

    Button(mainF, text='☰', command=toggle_win_menu, fg='black', bg='white', border=0, activebackground='white',
           activeforeground='#76448A', font=('SimSun', 20, 'bold')).place(x=1650, y=20, height=50, width=50)
    img = ImageTk.PhotoImage(Image.open("AdobeStock_289595573_Preview.jpeg").resize((50, 50)))
    l = Label(mainF, image=img)
    l.img = img
    l.place(height=50, width=50, x=1690, y=19)
...
def toggle_win_menu():
    global f1
    f1 = Frame(APP, width=300, height=940, bg='#12c4c0')
    f1.place(x=1450, y=10)

    Button(APP, text='X', command=menu, fg='black', bg='#12c4c0', border=0, activebackground='#12c4c0',
           activeforeground='#76448A', font=('Time New Roman', 25, 'bold')).place(x=1690, y=20, height=50, width=50)

    Button(APP, text='| | |', command=menu, fg='black', bg='#12c4c0', border=0, activebackground='#12c4c0',
           activeforeground='#76448A', font=('Time New Roman', 20, 'bold')).place(x=1650, y=20, height=50, width=50)
    ...
    bttn(0, 80, 'H O M E', '#0f9d9a', '#12c4c0',signin)
    ...
    bttn(0, 830, 'P O W E R D   B Y  P Y C H A R M  P R O J E C T S', 'yellow', '#12c4c0', None)
    bttn(0, 865, 'P Y T H O N   P R O J E C T  1 . 1', '#0f9d9a', '#12c4c0', None)
...
def av_cours():
    ...
    Button(mainF, text='previous',command=menu, fg='white', bg='#EF930C', border=0,
           ...
           activeforeground='#F85511', font=('SimSun', 18, 'bold')).place(x=1250, y=700, height=50, width=300)
    Button(mainF, text='Next',command=av_cours_next, fg='white', bg='#EF930C', border=0,
           activebackground='#F3F7D7',
           activeforeground='#F85511', font=('SimSun', 18, 'bold')).place(x=1250, y=800, height=50, width=300)

    Button(mainF, text='☰', command=toggle_win_av_cours, fg='black', bg='white', border=0, activebackground='white',
           activeforeground='#76448A', font=('SimSun', 20, 'bold')).place(x=1650, y=20, height=50, width=50)
    img = ImageTk.PhotoImage(Image.open("AdobeStock_289595573_Preview.jpeg").resize((50, 50)))
    l = Label(mainF, image=img)
    l.img = img
...
def av_cours_next():
    ...
    Button(mainF, text='previous', command=av_cours, fg='white', bg='#EF930C', border=0,
           activebackground='#F3F7D7',
           activeforeground='#F85511', font=('SimSun', 18, 'bold')).place(x=1250, y=700, height=50, width=200)
    Button(mainF, text='Loging', command=menu, fg='white', bg='#EF930C', border=0,
           activebackground='#F3F7D7',
           activeforeground='#F85511', font=('SimSun', 18, 'bold')).place(x=1250, y=800, height=50, width=200)

    Button(mainF, text='☰', command=toggle_win_av_cours_next, fg='black', bg='white', border=0, activebackground='white',
           activeforeground='#76448A', font=('SimSun', 20, 'bold')).place(x=1650, y=20, height=50, width=50)
    img = ImageTk.PhotoImage(Image.open("AdobeStock_289595573_Preview.jpeg").resize((50, 50)))
    l = Label(mainF, image=img)
    l.img = img
...
def signin():
    ...
    Button(mainF, text='Sign in',command=page1, fg='white', bg='blue', border=0, activebackground='#AED6F1',
    ...
    Button(mainF, text='☰', command=toggle_win_signin, fg='black', bg='white', border=0, activebackground='white',
           activeforeground='#76448A', font=('SimSun', 20, 'bold')).place(x=1650, y=20, height=50, width=50)
    img = ImageTk.PhotoImage(Image.open("AdobeStock_289595573_Preview.jpeg").resize((50, 50)))
    l = Label(mainF, image=img)
    l.img = img
...
def page1():
    ...
    img = ImageTk.PhotoImage(Image.open("png-transparent-abstract-background-technology-hexagonal-pattern.png").resize((750,950)))
    l = Label(mainF, image=img )
    l.img = img
    l.place(height=950, width=750, x=0, y=0)
    ...
    Label(mainF, text="  Choose Your Graede  ",
    ...
    Button(mainF, text='O\L Student', fg='white', bg='blue', border=0, activebackground='#AED6F1',
           activeforeground='#76448A', font=('SimSun', 15, 'bold')).place(x=1050, y=350, height=50, width=350)
    Button(mainF, text='A\L Student', fg='white', bg='blue', border=0, activebackground='#AED6F1',
           activeforeground='#76448A', font=('SimSun', 15, 'bold')).place(x=1050, y=450, height=50, width=350)
    Button(mainF, text='Univercity Student',command=uni_student, fg='white', bg='blue', border=0, activebackground='#AED6F1',
           activeforeground='#76448A', font=('SimSun', 15, 'bold')).place(x=1050, y=550, height=50, width=350)
    Button(mainF, text='Others', fg='white', bg='blue', border=0, activebackground='#AED6F1',
           activeforeground='#76448A', font=('SimSun', 15, 'bold')).place(x=1050, y=650, height=50, width=350)
...
def toggle_win_page1():
    ...
    bttn(0, 80, 'H O M E', '#0f9d9a', '#12c4c0',page1)
    bttn(0, 117, 'N O T I F I C A T I O N', '#0f9d9a', '#12c4c0',None)
    bttn(0, 154, 'S E T T I N G', '#0f9d9a', '#12c4c0', None)
    bttn(0, 191, 'A B O U T   U S', '#0f9d9a', '#12c4c0', None)
    bttn(0, 228, 'E X I T', '#0f9d9a', '#12c4c0', exit)
...
def uni_student():
    ...
    Button(mainF, text="1.Phython Language",command=python, fg='#5499C7', bg='white', border=0, activebackground='white',
          ...
          font=('SimSun', 15, 'bold')).place(x=800,
                                             y=200)
    ...
    Button(mainF, text="21.Bio Systerm Technology", fg='#5499C7', bg='white', border=0, activebackground='white',
           activeforeground='#EF930C',
           font=('SimSun', 15, 'bold')).place(x=1250,
                                              y=200)
   ...
   # Button(mainF, text='Engeneering Facalty', fg='white', bg='blue', border=0, activebackground='#AED6F1',
    ...
    Button(mainF, text='☰', command=toggle_win_un_std, fg='black', bg='white', border=0, activebackground='white',
           activeforeground='#76448A', font=('SimSun', 20, 'bold')).place(x=1650, y=20, height=50, width=50)
    img = ImageTk.PhotoImage(Image.open("AdobeStock_289595573_Preview.jpeg").resize((50, 50)))
    l = Label(mainF, image=img)
    l.img = img
...
def python():
    ...
    Label(mainF, text='Python Language', fg='white', bg='#EF930C', border=0,
          font=('SimSun', 18, 'bold')).place(x=850, y=100, height=30, width=800)
...
#tk.
    frame = Frame(mainF, padx=250, pady=150, bg="#fff")

    Label(mainF, text='Python - Home Questions', fg='white', bg='#EF930C', border=0,
          font=('SimSun', 18, 'bold')).place(x=250, y=50, height=30, width=1283)
